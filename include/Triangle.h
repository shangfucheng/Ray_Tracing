...
struct Triangle {
	...
	void position_update( glm::mat4 modelView){
		this->P[0] = glm::normalize(glm::mat3(modelView)*this->P[0]);
        this->P[1] = glm::normalize(glm::mat3(modelView)*this->P[1]);
        this->P[2] = glm::normalize(glm::mat3(modelView)*this->P[2]);
