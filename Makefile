...
RM = /bin/rm -f
all: SceneViewer
SceneViewer: main.o Shader.o Camera.o Image.o Obj.o Scene.o shaders/lighting.frag shaders/projective.vert
	$(CC) -o SceneViewer main.o Shader.o Camera.o Image.o Obj.o Scene.o $(LDFLAGS)
